...
(custom-set-faces
 ...
 '(eglot-semantic-defaultLibrary ((t (:inherit font-lock-builtin-face :foreground "#D9DAA2"))))
 '(eglot-semantic-operator ((t (:inherit font-lock-function-name-face :foreground "gainsboro"))))
 '(font-lock-keyword-face ((t (:foreground "#BF81BA"))))
 '(font-lock-type-face ((t (:foreground "#339CDB"))))
 ...
 '(org-level-1 ((t (:inherit outline-1 :extend t :foreground "dodger blue"))))
 '(org-level-2 ((t (:inherit outline-2 :extend t :foreground "cornflower blue"))))
 '(org-level-3 ((t (:inherit outline-3 :extend t :foreground "light steel blue"))))
